...
BOARD_KERNEL_CMDLINE := console=ttyMSM0,115200,n8 androidboot.console=ttyMSM0 androidboot.hardware=qcom user_debug=30 vmalloc=300M msm_rtb.filter=0x237 ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 earlycon=msm_hsl_uart,0x78B0000 buildvariant=user appjenkins=1228 modemjenkins = 65 buildsoftversion=1.3.0 builduser=root
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 18876416
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 18876416
